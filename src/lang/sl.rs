...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem TecDesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, TecDesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Click to download", "Klikni za prenos"),
        ("Click to update", "Klikni za posodobitev"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate TecDesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate TecDesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno TecDesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »TecDesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep TecDesk background service", "Ohrani TecDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije TecDesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "Za nadzor oddaljenega namizja s tipkovnico, rabi TecDesk pravico »Nadzor vnosa«."),
        ("config_microphone", "Za zajem zvoka, rabi TecDesk pravico »Snemanje zvoka«."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za TecDesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite TecDesk, prekinite klic in program zaprite."),
        ("scam_text2", "TecDesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prosimo, nadgradite TecDesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo TecDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno TecDeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri TecDesk storitvi v ozadju"),
