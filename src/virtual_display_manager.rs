...
//  https://github.com/rustdesk-org/TecDeskIddDriver/blob/b370aad3f50028b039aad211df60c8051c4a64d6/TecDeskIddDriver/TecDeskIddDriver.inf#LL73C1-L73C40
pub const RUSTDESK_IDD_DEVICE_STRING: &'static str = "TecDeskIddDriver Device\0";
...
pub mod amyuni_idd {
    ...
    // 2. TecDesk may crash and restart, but the virtual displays are kept.
    //
    ...
    //             if there're no virtual displays managed by TecDesk.
    pub fn plug_out_monitor(index: i32, force_all: bool, force_one: bool) -> ResultType<()> {
        ...
        //
        // 1. TecDesk plug in 2 virtual displays. (TecDesk)
        // 2. Other process plug out all virtual displays. (User mannually)
        // 3. Other process plug in 1 virtual display. (User mannually)
        // 4. TecDesk plug out all virtual displays in this call. (TecDesk disconnect)
        //
        // This is not a normal scenario, TecDesk will plug out virtual display unexpectedly.
