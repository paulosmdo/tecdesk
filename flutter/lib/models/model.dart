...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsTecDeskVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsTecDeskVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsTecDeskVirtualDisplays);
        }
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get TecDeskVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsTecDeskVirtualDisplays] ?? []);
