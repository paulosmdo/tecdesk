...
class MyTheme {
  ...
  static const Color accent50 = Color(0x77f97316);
  static const Color accent80 = Color(0xAAf97316);
  ...
  static const Color button = Color(0xFFf97316);
...
Future<void> onActiveWindowChanged() async {
  ...
  if (rustDeskWinManager.getActiveWindows().isEmpty) {
    ...
    try {
      ...
      debugPrint("Start closing TecDesk...");
      ...
      if (isMacOS) {
        ...
        // 2024-11-11 11:41:11.546 TecDesk[90272:2567686] Failed to create a FlutterPlatformMessageResponseHandle (2)
        // embedder.cc (2672): 'FlutterEngineSendPlatformMessage' returned 'kInvalidArguments'. Invalid engine handle.
        // 2024-11-11 11:41:11.565 TecDesk[90272:2567686] Failed to send message to Flutter engine on channel 'flutter/lifecycle' (2).
        // ```
