use librustdesk::api::TecDeskApiTable;
/// This file demonstrates how to write a custom plugin for TecDesk.
...
lazy_static::lazy_static! {
    ...
    // Do your own logic based on the API provided by TecDesk.
    pub static ref API: TecDeskApiTable = TecDeskApiTable::default();
}
