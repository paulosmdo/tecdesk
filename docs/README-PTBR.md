<p align="center">
  <img src="../res/logo-header.svg" alt="TecDesk - Seu desktop remoto"><br>
  ...
  <b>Precisamos de sua ajuda para traduzir este README e a <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">UI do TecDesk</a> para sua língua nativa</b>
</p>
...
TecDesk acolhe contribuições de todos. Leia [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) para ver como começar.
