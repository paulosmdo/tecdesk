<p align="center">
  <img src="../res/logo-header.svg" alt="TecDesk – vaše vzdálená plocha"><br>
  ...
  <b>Potřebujeme Vaši pomoc s překladem tohoto README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">uživatelského rozhraní aplikace TecDesk</a> a <a href="https://github.com/rustdesk/doc.rustdesk.com">dokumentace k ní</a> do vašeho jazyka</b>
</p>
...
Projekt TecDesk vítá přiložení ruky k dílu od každého. Jak začít se dozvíte z [`docs/CONTRIBUTING.md`](CONTRIBUTING.md).

[**Jak TecDesk funguje?**](https://github.com/rustdesk/rustdesk/wiki/How-does-TecDesk-work%3F)
