<p align="center">
  ...
  <b>  لغتك الأم,  <a href="https://github.com/rustdesk/doc.rustdesk.com">Doc</a> و <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">TecDesk UI</a>, README نحن بحاجة إلى مساعدتك لترجمة هذا </b>
</p>
...
لمساعدتك على ذلك [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) يرحب بمساهمة الجميع. اطلع على  TecDesk.

[**؟ TecDesk كيفية يعمل**](https://github.com/rustdesk/rustdesk/wiki/How-does-TecDesk-work%3F)
...
TecDesk يرجى التأكد من أنك تنفذ هذه الأوامر من جذر مستودع
