<p align="center">
  <img src="../res/logo-header.svg" alt="TecDesk - Etätyöpöytäsi"><br>
...
TecDesk toivottaa avustukset tervetulleiksi kaikilta. Katso lisätietoja [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) avun saamiseksi.
