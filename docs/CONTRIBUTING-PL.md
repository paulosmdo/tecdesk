# Współtworzenie TecDesk

TecDesk z zadowoleniem przyjmuje wkład od każdego. Oto wytyczne, jeśli chcesz nam pomóc:

## Współtwórcy

Contributions to TecDesk or its dependencies should be made in the form of GitHub
...
TecDesk contributors frequent the [Discord](https://discord.gg/nDceKgxnkV).
